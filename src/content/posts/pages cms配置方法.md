...
- 1你需要一个github账号
- 2你的部署环境可以自动拉取github仓库

## 开始配置pages

- [访问pagescms.org](http://访问pagescms.org)
- 关联你的github账号
- 找到博客仓库
  ...
  - name: layout-appearance
    ...
    items:
      ...
      - name: background-wallpaper
        ...
        format: code
        description: 全屏壁纸、横幅壁纸、视频背景、水波纹、渐变等背景特效
  ...
  - name: feature-settings
    ...
    items:
      ...
      - name: effects-config
        ...
        format: code
        description: 樱花飘落动画的数量、速度、尺寸、透明度等参数
...
- 直接粘贴到.pages.yml即可
- 如果你的部署环境不能拉取github仓库那么你就没办法使用pages
- 此配置文件只配置了默认的几个标签如果不够用请问deepseek或者GPT
